...
\usepackage[breaklinks=true,hidelinks]{hyperref} %Make sure this \usepackage is the last one - http://tex.stackexchange.com/a/3098
%\usepackage[options]{nohyperref} %uncomment this to disable hyperlinks
